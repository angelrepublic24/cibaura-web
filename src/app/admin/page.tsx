...
/**
 * /admin — platform commission %. The value is SNAPSHOTTED into each booking's
 * pricing at request time, so changing it only affects future requests; it
 * never rewrites existing bookings (docs/DOMAIN.md, invariant #2).
 */
      ...
      <Card className="mt-6 max-w-lg">
        <CardHeader>
          ...
          <CardDescription>
            ...
            snapshot at request time. Editing it never changes existing
            bookings.
          </CardDescription>
        </CardHeader>
        <CardContent>
